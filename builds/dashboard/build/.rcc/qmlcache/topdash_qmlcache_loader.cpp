...
namespace _0x5f_TopDash_qml_Main_qml { 
...
namespace _0x5f_TopDash_qml_MediaView_qml { 
    extern const unsigned char qmlData[];
    extern const QQmlPrivate::AOTCompiledFunction aotBuiltFunctions[];
    const QQmlPrivate::CachedQmlUnit unit = {
        reinterpret_cast<const QV4::CompiledData::Unit*>(&qmlData), &aotBuiltFunctions[0], nullptr
...
namespace _0x5f_TopDash_qml_PerformanceView_qml { 
    extern const unsigned char qmlData[];
    extern const QQmlPrivate::AOTCompiledFunction aotBuiltFunctions[];
    const QQmlPrivate::CachedQmlUnit unit = {
        reinterpret_cast<const QV4::CompiledData::Unit*>(&qmlData), &aotBuiltFunctions[0], nullptr
...
int QT_MANGLE_NAMESPACE(qInitResources_qmlcache_topdash)() {
    ::unitRegistry();
    return 1;
}
Q_CONSTRUCTOR_FUNCTION(QT_MANGLE_NAMESPACE(qInitResources_qmlcache_topdash))
int QT_MANGLE_NAMESPACE(qCleanupResources_qmlcache_topdash)() {
    return 1;
}
